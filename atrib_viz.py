...
class AttributesVisualization:
    def __init__(self, tree):
        self.widgets = []
        self.visualize_attrib_freq_and_impact(tree)


    # main function for visualising attribute frequency and importance
    def visualize_attrib_freq_and_impact(self, tree):
        ...
        self.widgets.append(default_rb)
        self.widgets.append(freq_rb)
        self.widgets.append(impact_rb)
